...
router.post('/bulk-delete', requireRole(...COMPANY_ADMIN_ROLES), bulkDeleteClients);
router.get('/:id/dependencies', requireRole(...COMPANY_ADMIN_ROLES), getClientDependencies);
